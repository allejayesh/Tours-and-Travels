<%@ Page Title="" Language="C#" MasterPageFile="~/TravelWorld.Master" AutoEventWireup="true" CodeBehind="Hotel Management.aspx.cs" Inherits="Tours_and_Travels.Hotel_Management" %>
    ...
    <div class="container">
        ...
        <div class="card" >
            <div class="card-boby">
                ...
                <div class="row">
                    <div class="col">
                       <center><h2 style="font-family:'Dancing Script', cursive;">Hotel Management</h2></center>  
                    </div>
                </div>
                <hr />
              ...
              <div class="row" style="padding-left:20px;">
                   <div class="col">
                       <h5><asp:Label ID="lblID" runat="server" Text="ID"></asp:Label></h5>
                        <div class="form-group">
                            <asp:TextBox ID="TextBox1" runat="server" placeholder="Id"  Width="250px" ></asp:TextBox>       
                ...
                <div class="row" style="padding-left:20px;">
                   <div class="col">
                       <h5><asp:Label ID="lblPlaceName" runat="server" Text="Hotel"></asp:Label></h5>
                        <div class="form-group">
                            <asp:TextBox ID="TextBox2" runat="server" placeholder="HotelName" Width="250px"></asp:TextBox>   
       ...
       <!--      <div class="row"style="padding-left:20px;">
                 ...
                 <div class="row" style="padding-left:20px;">
                   <div class="col">
                       <h5><asp:Label ID="lblAmount" runat="server" Text="Amount"></asp:Label></h5>
                        <div class="form-group">
